...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LCTL, LCTL(KC_TAB), KC_LWIN, LALT_T(KC_ENT), LT(_LR1, KC_MHEN), KC_SPC, LT(_LR2, KC_ZKHK),     KC_ENT,  MO(_LR1), MO(_LR2), JP_HAT,  JP_AT,  JP_BSLS,         JP_YEN
    ),
    [_LR1] = LAYOUT(
    ...
    [_LR2] = LAYOUT(
        ...
        _______, KC_1,       KC_2,    KC_3,    KC_4,    KC_5,    KC_BSPC,    XXXXXXX, KC_WH_U, KC_MS_L, KC_MS_U, KC_MS_R, KC_BTN1, KC_BTN3,
        _______, KC_6,       KC_7,    KC_8,    KC_9,    KC_0,    KC_END,     XXXXXXX, KC_WH_D, KC_WH_L, KC_MS_D, KC_WH_R, KC_BTN2, XXXXXXX,
        _______, S(KC_CAPS), _______, _______, _______, _______, _______,    _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
    )
};
